...
def calc_lum(freq):
    ...
    lum = int(round((freq - 3500) / 3.1372549))
...
#        image_data = self._decode_image_data(vis_end)
    ...
    def _find_header(self):
        ...
        for current_sample in range(0, len(self._samples) - header_size,
            ...
            if (abs(self._peak_fft_freq(leader_1_area) - 3900) < 50
               and abs(self._peak_fft_freq(break_area) - 3200) < 50
               and abs(self._peak_fft_freq(leader_2_area) - 3900) < 50
               and abs(self._peak_fft_freq(vis_start_area) - 3200) < 50):
    ...
    def _align_sync(self, align_start, start_of_sync=True):
        ...
        for current_sample in range(align_start, align_stop):
            ...
            if self._peak_fft_freq(search_section) > 3350:
                break
