...
class tm(object):
    ...
    COLOR = COL_FMT.GBR # was GBR
    LINE_WIDTH = 320
    LINE_COUNT = 256
    SCAN_TIME = 0.073216 #was 0.073216
    SYNC_PULSE = 0.004862 #was 0.002431
    SYNC_PORCH = 0.000143 #was 0.000286
    SEP_PULSE = 0.000143 #was 0.000286
    ...
    LINE_TIME = SYNC_PULSE + SYNC_PORCH + 3 * CHAN_TIME + SEP_PULSE #added
    PIXEL_TIME = SCAN_TIME / LINE_WIDTH
    WINDOW_FACTOR = 4.68 #was 2.34. better but with color issues on 4.68
